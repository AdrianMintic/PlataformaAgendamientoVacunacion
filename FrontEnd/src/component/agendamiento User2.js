      ...
      <main class="main">
			<section class="section"/>
                ...
                <input type="number"/>
						...
						<tr>
							<th>
                <button class="button modal-trigger" data-target="modaldeusuarios">Consultar</button>
              </th>
						 <th float="left">{usuarios[0].nombres}</th>
						</tr>
					</table>
				</div>
				<br />
...
export default AgendamientoUser2
